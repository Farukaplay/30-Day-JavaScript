...
//     if(i % 2 == 0){
//         createDiv.style.backgroundColor = "#50C878"
//         createDiv.innerHTML = i
//         console.log(i);
//     }else{
//         createDiv.style.backgroundColor = "#FFC300"
//         createDiv.innerHTML = i
//         console.log(i);
//     }
// }
...
//   createDiv.style.height = "130px"
//   createDiv.style.borderRadius = "6px"
//   createDiv.style.border = "2px solid #DDD"
...
//   createDiv.style.boxShadow  = "0 0 5px 2px #DDD"
//   createDiv.innerHTML = name.name
...
titleYear = asabenehChallenges2020.challengeYear


setInterval( function randomRgb (){
  ...
  return title.innerHTML = `${asabenehChallenges2020.challengeTitle} <span style= "color:${color}; font-size: 45px">${titleYear}</span>` 
...
let monthSource = ["January", "Februray", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"]
let dateDiv = document.createElement("div")
dateDiv.style.padding = "10px 15px"
...
setInterval(
  function time(){
    ...
    let month = monthSource[date.getMonth()]
    dateDiv.style.backgroundColor = color
    
    return dateDiv.innerHTML = `${month} ${date.getDate()},${date.getFullYear()} ${hour}:${minutes}:${second}`
  }, 1000)
...
let challengesName =  asabenehChallenges2020.challenges
let counter = 0

challengesName.forEach((challenges, index) => {
  
  let createLi = document.createElement("li")
  createLi.style.width = "100"
  createLi.style.padding = "15px"
  createLi.style.listStyle = "none"
  createLi.style.marginBottom = "5px"
  createLi.style.listStylePosition = "inital"
  createLi.style.display = "flex"
  createLi.style.justifyContent = "space-between" 
  let topics = ""
  let topicsName = ["Python", "JavaScript", "HTML & CSS", "React", "ReactNative", "Fullstack", "Data Analysis", "Machine Learning"]

  for(let i = 0; i < challenges.topics.length; i++){

    topics += `<summary>${challenges.topics[i]} </summary>`
  }
  
  createLi.innerHTML += ` ${challenges.name} <details><summary>${topicsName[counter]} </summary> ${topics}</details>`
  counter ++

  if(index == 0){
   
    createLi.innerHTML += challenges.status
    createLi.style.backgroundColor = "#50C878"
    createLi.style.textDecoration = "underline"
  }else if(index == 1){

    createLi.innerHTML += challenges.status
    createLi.style.backgroundColor = "#FFC300"
    createLi.style.textDecoration = "underline"
  }else{

    createLi.innerHTML += challenges.status
    createLi.style.backgroundColor = "#fb3e3e"
  }
...
authorInfo.style.fontSize = "26px"
authorInfo.style.fontWeight = "600"
authorInfo.style.display = "flex"
authorInfo.style.flexDirection = "column"
authorInfo.style.marginBottom = "50px"
authorInfo.style.maxWidth = "80%"
...
asabenehChallenges2020.author.socialLinks.forEach(link => {
  ...
  links.href = link.url
  links.innerHTML = link.fontawesomeIcon
...
bio.innerHTML = asabenehChallenges2020.author.bio 

let authorTitles = document.createElement("div")
authorTitles.style.display = "flex"
authorTitles.style.justifyContent = "space-between"
authorTitles.style.gap = "30px"
authorTitles.style.marginTop = "30px"
...
titles.style.gap = "5px"
titles.style.fontSize = "22px"
...
for(let i = 0; i < asabenehChallenges2020.author.titles.length; i++){
  ...
  titleItem.style.fontWeight = "400"
  titleItem.innerHTML = asabenehChallenges2020.author.titles[i]
...
for(let i = 0; i < asabenehChallenges2020.author.titles.length; i++){
  ...
  skillItem.innerHTML = `<i class="fa-solid fa-check" style= "background-color: green; color:white; border-radius: 3px"></i>` 
  skillItem.style.fontSize = "16px"
  skillItem.style.fontWeight = "400"
  skillItem.style.display = "flex"
  skillItem.style.gap = "5px"
  skillItem.innerHTML += asabenehChallenges2020.author.skills[i]
  skills.append(skillItem)
}


let qualifications = document.createElement("div")
qualifications.innerHTML = "Qualifications"
qualifications.style.display = "flex"
qualifications.style.flexDirection  ="column"
qualifications.style.gap = "5px"
qualifications.style.fontSize = "22px"

for(let i = 0; i < asabenehChallenges2020.author.qualifications.length; i++){

  let qualItem = document.createElement("span")
  qualItem.style.fontSize = "16px"
  qualItem.style.fontWeight = "400"
  qualItem.innerHTML = asabenehChallenges2020.author.qualifications[i]
  qualifications.append(qualItem)
}


authorTitles.append(titles, skills, qualifications)
...
keyword.style.width = "80%"
keyword.style.fontSize = "22px"
keyword.style.display = "flex"
keyword.style.flexDirection = "column"


let keywordTitle = document.createElement("p")
keywordTitle.textContent = "Keyword"
keywordTitle.style.margin = "0"


let keywordTag = document.createElement("div") 
keywordTag.style.display = "flex"
keywordTag.style.justifyContent = "center"
keywordTag.style.gap = "15px"
keywordTag.style.flexWrap = "wrap"
keywordTag.style.padding = "20px"
...
for(let i = 0; i < asabenehChallenges2020.keywords.length; i++){
  ...
  keywordItem.style.borderRadius = "6px"
  keywordItem.style.backgroundColor = color
  keywordItem.style.padding = "5px"
  keywordItem.style.fontSize = "14px"
  keywordItem.innerHTML = "#" + asabenehChallenges2020.keywords[i]
  
  keywordTag.append(keywordItem)
}

keyword.append(keywordTitle, keywordTag)
authorInfo.append(author, socialDiv, bio, authorTitles)
body.append(title, subTitle, dateDiv, list, authorInfo, keyword)