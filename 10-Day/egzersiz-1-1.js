...
// let stringArray = ["Faruk", "Kaplay", "HTML", "CSS", "JS"];

// let stringArraySet = new Set(stringArray)

// console.log(stringArraySet)
...
// let mostSpokenCountrySet = new Set(languages)
// console.log(mostSpokenCountrySet);

// for (let lang of mostSpokenCountrySet){

//   const filteredLang = languages.filter( (langC) => langC === lang)
