...
for(let pop of countries_data){

    populationResult = populationResult + pop.population
    country.push({name: pop.name, population: pop.population})
}
...
for(let country of countries_data){
    ...
    language.push(country.languages[j]);
}

// console.log(language);

let setLang = new Set(language)
// console.log(setLang);

let countLang = []

for(let lang of setLang){
    let filtered = language.filter(language => language === lang)
    // console.log(filtered);
    countLang.push({language:lang, count: filtered.length})
}
    ...
    if(countryShow == false){
        ...
        for(let i = 0; i < 11; i++){
            ...
            if(country[i].name == "United States of America"){
                ...
                country[i].name = "USA"
            }else if(country[i].name == "Russian Federation"){
                
                country[i].name = "Russia"
            }
            countries.innerHTML =` <span>${country[i].name}</span> <div><span style= width:100%></span></div> <span>${country[i].population}</span>`
...
buttonLanguages.addEventListener("click", () => {
    ...
    if(languageShow == false){
        ...
        for(let i = 0; i < 11; i++){
            ...
            languages.innerHTML =` <span>${countLang[i].language}</span> <div><span style= width:${countLang[i].count}%></span></div> <span>${countLang[i].count}</span>`
